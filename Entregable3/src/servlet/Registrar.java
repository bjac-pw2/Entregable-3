...
public class Registrar extends HttpServlet {
	...
	public void doGet(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException {
		...
		String contenido="<h3>Su Datos Personales ha sido enviando exitosamente a la Clinica Ultima Esperanza,"
				...
				+"<h5>Mientras podria visitar esta pagina <a href='http://likeimi-c.appspot.com'>LiKeimi</a> para distraerse</h5></h3>";
